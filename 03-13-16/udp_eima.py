...
if 2<= len(sys.argv) <= 3 and sys.argv[1] == 'server':
	...
	print "Max Throughput: " + str(max(through))
	print "Max Packet Loss: " + str(max(ploss))

	print "Min RTT: " + str(min(rtt))
	print "Min Throughput: " + str(min(through))
	print "Min Packet Loss: " + str(min(ploss))

	print "Ave RTT: " + str(sum(rtt)/float(len(rtt)))
	print "Ave Throughput: " + str(sum(through)/float(len(through)))
	print "Ave Packet Loss: " + str(sum(ploss)/float(len(ploss)))
